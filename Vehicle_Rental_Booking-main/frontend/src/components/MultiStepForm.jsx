...
const steps = ["Select Vehicle Type", "Select Vehicle", "Confirm Booking", "Review and Submit"];
  ...
  return (
    <Box sx={{ width: "50%", margin: "auto", mt: 5 }}>
      ...
      <Box sx={{ mt: 4 }}>
        ...
        {activeStep === 3 && <StepFour formData={formData} setFormData={setFormData} />} {/* Added StepFour */}
